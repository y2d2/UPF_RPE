...
from RPE_Code.UtilityCode.utility_fuctions import sphericalToCartesian, limit_angle, transform_matrix, \
...
class TwoAgentSystem():
    ...
    def set_ukf_properties(self, kappa=-1, alpha=1, beta=2, n_azimuth=4, n_altitude=3, n_heading=4, resample_factor =0.1, sigma_uwb_factor= 1.0):
        self.kappa = kappa
        self.alpha = alpha
        self.beta = beta
