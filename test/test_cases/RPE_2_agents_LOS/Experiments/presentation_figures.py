...
class MyTestCase(unittest.TestCase):
    ...
    def create_experiment(self, results_folder, sig_v, sig_w, sig_uwb):
        ...
        tas = Simulation.MultiRobotClass.TwoAgentSystem(trajectory_folder="./", result_folder=results_folder)
        tas.debug_bool = True
        tas.plot_bool = True
    ...
    def test_show_unob_uncertainty(self):
        from ParticleFilter.ConnectedAgentClass import UPFConnectedAgent, UPFConnectedAgentDataLogger
