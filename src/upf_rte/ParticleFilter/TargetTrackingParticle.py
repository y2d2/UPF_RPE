...
from upf_rte.UtilityCode.utility_fuctions import cartesianToSpherical, get_4d_rot_matrix
...
class TargetTrackingParticle:
    def __init__(self,  weight = 1., parent=None):
        self.weight = weight
        self.parent = parent
        self.likelihood = 1.
        self.rpea = None
...
class UKFLOSTargetTrackingParticle(TargetTrackingParticle):
    def __init__(self, weight=1., parent=None):
        ...
        self.rpea_type = TargetTrackingUKF
        # self.get_states()
