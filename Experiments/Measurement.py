...
def load_custom_messages():
    ...
    from rosbags.typesys.types import yd_uwb_msgs__msg__UWBRangeStamp as UWBRangeStamp
    ...
    from rosbags.typesys.types import yd_uwb_msgs__msg__UWBRange as UWBRange
    ...
    from rosbags.typesys.types import vicon_receiver__msg__Position as Position
    #####################################################################################
